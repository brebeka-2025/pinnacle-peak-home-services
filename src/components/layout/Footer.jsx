        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Professional home watch services for North Scottsdale's most discerning homeowners.
            </p>
            <a href="tel:4805551234" className="block text-brand-gold hover:underline font-semibold mb-1">
              (480) XXX-XXXX
            </a>
            <a href="mailto:john@pinnaclepeakhomeservices.com" className="block text-brand-gold hover:underline text-sm">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <div className="bg-white rounded-lg px-3 py-2">
                <img src="/Veteran_Logo.png" alt="Veteran Owned" className="h-8 object-contain" />
              </div>
              <div className="bg-white rounded-lg px-3 py-2">
                <img src="/SBA_Logo.jpg" alt="SBA Certified" className="h-8 object-contain" />
              </div>
            </div>
          </div>
